...
const API = 'AIzaSyDEkCrNf-S8CjTnm5dF7LE4_uZ3EwTqhJo'
      ...
      <div>
        <button onClick={(i)=>this.clicked(i)}>Get youtube videos</button>
        {
          this.state.resultyt.map((link, i) => {
            console.log(link);
            const frame = <div key={i} className="youtube"><iframe title="example" width="560" height="315" src={link} frameBorder="0" allowFullScreen /></div>
            return frame
          })
        }
        {/*{this.frame}*/}
